...
public class STATOQueries {
    ...
    static{
        ...
        QUERY_STRING[7] = "Which statistical tests use 'normal distribution'?";
        QUERY_DL[7] = "'statistical hypothesis test' and 'has part' some ('normal distribution hypothesis' and 'has value' value true)";

        //PLOTS
        QUERY_STRING[8] = "Which plots may be produced in a genetic association study?";
        ...
        QUERY_STRING[9] = "Which plots may be produced in a meta-analysis?";
        ...
        QUERY_STRING[11] = "Which plots use effect size estimate?";
        ...
        //STUDY DESIGN
        QUERY_STRING[13] = "Which study designs use time as blocking variable?";
